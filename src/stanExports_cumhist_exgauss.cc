...
#include "stanExports_cumhist_exgauss.h"

RCPP_MODULE(stan_fit4cumhist_exgauss_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_cumhist_exgauss")
