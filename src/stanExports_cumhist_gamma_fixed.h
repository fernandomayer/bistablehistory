...
namespace model_cumhist_gamma_fixed_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cumhist_gamma_fixed");
    ...
    reader.add_event(63, 11, "restart", "model_cumhist_gamma_fixed");
    ...
    reader.add_event(98, 14, "restart", "model_cumhist_gamma_fixed");
    ...
    reader.add_event(102, 15, "restart", "model_cumhist_gamma_fixed");
    ...
    reader.add_event(113, 23, "restart", "model_cumhist_gamma_fixed");
    reader.add_event(118, 28, "include", "/parameters/fixed_effects.stan");
    reader.add_event(118, 0, "start", "/parameters/fixed_effects.stan");
    reader.add_event(122, 4, "end", "/parameters/fixed_effects.stan");
    reader.add_event(122, 29, "restart", "model_cumhist_gamma_fixed");
    reader.add_event(124, 31, "include", "/transformed_parameters/history_computation.stan");
    reader.add_event(124, 0, "start", "/transformed_parameters/history_computation.stan");
    reader.add_event(158, 34, "end", "/transformed_parameters/history_computation.stan");
    reader.add_event(158, 32, "restart", "model_cumhist_gamma_fixed");
    reader.add_event(160, 34, "include", "/model/common.stan");
    reader.add_event(160, 0, "start", "/model/common.stan");
    reader.add_event(170, 10, "end", "/model/common.stan");
    reader.add_event(170, 35, "restart", "model_cumhist_gamma_fixed");
    reader.add_event(171, 36, "include", "/model/fixed_effects.stan");
    reader.add_event(171, 0, "start", "/model/fixed_effects.stan");
    reader.add_event(175, 4, "end", "/model/fixed_effects.stan");
    reader.add_event(175, 37, "restart", "model_cumhist_gamma_fixed");
    reader.add_event(203, 63, "end", "model_cumhist_gamma_fixed");
    return reader;
}
...
class model_cumhist_gamma_fixed
  : public stan::model::model_base_crtp<model_cumhist_gamma_fixed> {
private:
        int rowsN;
        ...
        int lmN;
public:
    model_cumhist_gamma_fixed(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cumhist_gamma_fixed_namespace::model_cumhist_gamma_fixed";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int iClear = 1; iClear <= clearN; ++iClear) {
                ...
                lp_accum__.add(gamma_log<propto__>(get_base1(clear_duration, iClear, "clear_duration", 1), stan::math::exp(((get_base1(a, 1, "a", 1) + (get_base1(bHistory, 1, "bHistory", 1) * get_base1(history_mix, iClear, "history_mix", 1))) + sum(elt_multiply(get_base1(bFixed, 1, "bFixed", 1), get_base1(fixed_effect, iClear, "fixed_effect", 1))))), (1 / stan::math::exp(((get_base1(a, 2, "a", 1) + (get_base1(bHistory, 2, "bHistory", 1) * get_base1(history_mix, iClear, "history_mix", 1))) + sum(elt_multiply(get_base1(bFixed, 2, "bFixed", 1), get_base1(fixed_effect, iClear, "fixed_effect", 1))))))));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cumhist_gamma_fixed_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int iClear = 1; iClear <= clearN; ++iClear) {
                ...
                stan::math::assign(shape, stan::math::exp(((get_base1(a, 1, "a", 1) + (get_base1(bHistory, 1, "bHistory", 1) * get_base1(history_mix, iClear, "history_mix", 1))) + sum(elt_multiply(get_base1(bFixed, 1, "bFixed", 1), get_base1(fixed_effect, iClear, "fixed_effect", 1))))));
                current_statement_begin__ = 193;
                stan::math::assign(scale, stan::math::exp(((get_base1(a, 2, "a", 1) + (get_base1(bHistory, 2, "bHistory", 1) * get_base1(history_mix, iClear, "history_mix", 1))) + sum(elt_multiply(get_base1(bFixed, 2, "bFixed", 1), get_base1(fixed_effect, iClear, "fixed_effect", 1))))));
    ...
    std::string model_name() const {
        return "model_cumhist_gamma_fixed";
    }
...
typedef model_cumhist_gamma_fixed_namespace::model_cumhist_gamma_fixed stan_model;
#ifndef USING_R
