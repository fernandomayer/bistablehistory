...
#include "stanExports_cumhist_lognormal.h"

RCPP_MODULE(stan_fit4cumhist_lognormal_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_cumhist_lognormal")
