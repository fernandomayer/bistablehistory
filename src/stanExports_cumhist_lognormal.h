...
namespace model_cumhist_lognormal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cumhist_lognormal");
    ...
    reader.add_event(63, 11, "restart", "model_cumhist_lognormal");
    ...
    reader.add_event(98, 14, "restart", "model_cumhist_lognormal");
    ...
    reader.add_event(104, 17, "restart", "model_cumhist_lognormal");
    reader.add_event(111, 24, "include", "/transformed_parameters/history_computation.stan");
    reader.add_event(111, 0, "start", "/transformed_parameters/history_computation.stan");
    reader.add_event(145, 34, "end", "/transformed_parameters/history_computation.stan");
    reader.add_event(145, 25, "restart", "model_cumhist_lognormal");
    reader.add_event(147, 27, "include", "/model/common.stan");
    reader.add_event(147, 0, "start", "/model/common.stan");
    reader.add_event(157, 10, "end", "/model/common.stan");
    reader.add_event(157, 28, "restart", "model_cumhist_lognormal");
    reader.add_event(181, 50, "end", "model_cumhist_lognormal");
    return reader;
}
...
class model_cumhist_lognormal
  : public stan::model::model_base_crtp<model_cumhist_lognormal> {
private:
        int rowsN;
...
public:
    model_cumhist_lognormal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cumhist_lognormal_namespace::model_cumhist_lognormal";
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "bHistory", "double", context__.to_vec());
        double bHistory(0);
        bHistory = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(bHistory);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 106;
            local_scalar_t__ bHistory;
            (void) bHistory;  // dummy to suppress unused var warning
            if (jacobian__)
                bHistory = in__.scalar_constrain(lp__);
            else
                bHistory = in__.scalar_constrain();
            current_statement_begin__ = 107;
            ...
            for (int iClear = 1; iClear <= clearN; ++iClear) {
                ...
                lp_accum__.add(lognormal_log<propto__>(get_base1(clear_duration, iClear, "clear_duration", 1), stan::math::exp((a + (bHistory * get_base1(history_mix, iClear, "history_mix", 1)))), sigma));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("lognormal_mu");
    }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cumhist_lognormal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        vars__.push_back(a);
        double bHistory = in__.scalar_constrain();
        vars__.push_back(bHistory);
        ...
        try {
            ...
            double lognormal_mu;
            (void) lognormal_mu;  // dummy to suppress unused var warning
            stan::math::initialize(lognormal_mu, DUMMY_VAR__);
            stan::math::fill(lognormal_mu, DUMMY_VAR__);
            // generated quantities statements
            current_statement_begin__ = 171;
            for (int iClear = 1; iClear <= clearN; ++iClear) {
                current_statement_begin__ = 172;
                stan::math::assign(lognormal_mu, stan::math::exp((a + (bHistory * get_base1(history_mix, iClear, "history_mix", 1)))));
                current_statement_begin__ = 173;
                stan::model::assign(predicted_duration, 
                            stan::model::cons_list(stan::model::index_uni(iClear), stan::model::nil_index_list()), 
                            stan::math::exp((lognormal_mu + ((sigma * sigma) / 2))), 
                            "assigning variable predicted_duration");
                current_statement_begin__ = 174;
                stan::model::assign(log_lik, 
                            stan::model::cons_list(stan::model::index_uni(iClear), stan::model::nil_index_list()), 
                            lognormal_log(get_base1(clear_duration, iClear, "clear_duration", 1), lognormal_mu, sigma), 
    ...
    std::string model_name() const {
        return "model_cumhist_lognormal";
    }
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        param_name_stream__.str(std::string());
        param_name_stream__ << "lognormal_mu";
        param_names__.push_back(param_name_stream__.str());
    }
...
typedef model_cumhist_lognormal_namespace::model_cumhist_lognormal stan_model;
#ifndef USING_R
