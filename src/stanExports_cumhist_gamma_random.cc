...
#include "stanExports_cumhist_gamma_random.h"

RCPP_MODULE(stan_fit4cumhist_gamma_random_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_cumhist_gamma_random")
