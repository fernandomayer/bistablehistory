...
namespace model_cumhist_normal_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_cumhist_normal");
    ...
    reader.add_event(63, 11, "restart", "model_cumhist_normal");
    ...
    reader.add_event(98, 14, "restart", "model_cumhist_normal");
    ...
    reader.add_event(104, 17, "restart", "model_cumhist_normal");
    ...
    reader.add_event(145, 25, "restart", "model_cumhist_normal");
    ...
    reader.add_event(157, 28, "restart", "model_cumhist_normal");
    reader.add_event(179, 48, "end", "model_cumhist_normal");
    return reader;
}
...
class model_cumhist_normal
  : public stan::model::model_base_crtp<model_cumhist_normal> {
private:
        int rowsN;
...
public:
    model_cumhist_normal(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_cumhist_normal_namespace::model_cumhist_normal";
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            for (int iClear = 1; iClear <= clearN; ++iClear) {
                ...
                lp_accum__.add(normal_log<propto__>(get_base1(clear_duration, iClear, "clear_duration", 1), (a + (bHistory * get_base1(history_mix, iClear, "history_mix", 1))), sigma));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_cumhist_normal_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            for (int iClear = 1; iClear <= clearN; ++iClear) {
                ...
                stan::model::assign(predicted_duration, 
                            ...
                            (a + (bHistory * get_base1(history_mix, iClear, "history_mix", 1))), 
                            "assigning variable predicted_duration");
                current_statement_begin__ = 172;
                stan::model::assign(log_lik, 
                            stan::model::cons_list(stan::model::index_uni(iClear), stan::model::nil_index_list()), 
                            normal_log(get_base1(clear_duration, iClear, "clear_duration", 1), get_base1(predicted_duration, iClear, "predicted_duration", 1), sigma), 
...
typedef model_cumhist_normal_namespace::model_cumhist_normal stan_model;
#ifndef USING_R
